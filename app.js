...
function run(){
    ...
    check(pattern);//Guarda el resultado en la variable result de Network

    $("#result").html("Result: "+net.result);
    console.log("nombre resultado " +net.result);
    //drawPattern('A',patternsLoaded[result]);
